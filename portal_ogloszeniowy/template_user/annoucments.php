...
$zapytanieTest = "SELECT * FROM serwis_ogloszeniowy.annoucments INNER JOIN serwis_ogloszeniowy.users ON serwis_ogloszeniowy.annoucments.id_user = serwis_ogloszeniowy.users.id_user";
                ...
                <a href="annoucmentPage.php?id=<?php echo $ogloszenie["id"] ?>" class="annoucment-page-link">
                    <div class="annoucment-box">
                        ...
                        <div class="annoucment-box-text">
                            <div class="author-data-post-text">
                                <h4><?php echo $ogloszenie["name"] . " " . $ogloszenie["surname"] ?></h4>
                                <p class="data-text"><?php echo date("j.d.Y H:i", strtotime($ogloszenie["date_added"]))?></p>
                            </div>
